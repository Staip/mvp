...
export const en: Messages = {
  ...
  copilot: {
    ...
    placeholder: 'e.g. "I need to register temporary residence in Split"',
    voice: {
      start: "Speak",
      stop: "Stop",
      listening: "Listening…",
    ...
    guide: {
      ...
      questionsIntro:
        "Answer these short questions — we'll create your document to download.",
      documentUploadInStep:
        "Upload a photo of the completed form or supporting document",
