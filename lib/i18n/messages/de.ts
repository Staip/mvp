...
export const de: Messages = {
  ...
  copilot: {
    ...
    guide: {
      ...
      checklistDesc:
        "Haken Sie jeden Schritt ab — der Fortschritt wird live aktualisiert.",
      documentsTitle: "Erforderliche Dokumente",
      documentsNote:
        "Dokumentvorschau ist Demo — bringen Sie Originale ins Amt.",
      view: "Ansehen",
      mapTitle: "Wohin in Split",
      mapDesc: "Demo-Karte — Standorte für Ihren Vorgang",
      mapIframeTitle: "Karte Split",
    },
  },
  api: {
