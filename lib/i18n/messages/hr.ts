...
export const hr: Messages = {
  ...
  copilot: {
    ...
    guide: {
      ...
      idStepFront: "Prednja strana",
      idStepBack: "Stražnja strana",
      idUploadFront: "Učitaj prednju stranu",
      idUploadBack: "Učitaj stražnju stranu",
      idScanning: "AI skenira dokument…",
      ...
      generatingPdf: "Pripremam PDF…",
      downloadPackagePdf: "Preuzmi registracijski paket (PDF)",
      pdfApplicantSection: "I. Podaci o podnositelju",
      pdfVehicleSection: "II. Podaci o vozilu",
      pdfPriorUploadsSection: "III. Prilozi (skenirano)",
      pdfAttachmentsSection: "IV. Popis priloga",
      pdfIdSubsection: "Osobna iskaznica",
      completeIdScanFirst: "Prvo dovršite sken ID-a u koraku 1.",
    },
  },
  api: {
